sqlcmd -i "c:\Program Files (x86)\dp\deadpoolscripts\dp.sql" -o "c:\Program Files (x86)\dp\deadpooldata\1.csv" -s, -W
...
findstr /v /c:"Changed database context to 'ToniqDatabase'." "c:\Program Files (x86)\dp\deadpooldata\3.csv" > "c:\Program Files (x86)\dp\deadpooldata\x.csv" 
