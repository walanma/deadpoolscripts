sqlcmd -i "c:\dp\deadpoolscripts\unichem_russell_street.sql" -o "c:\dp\deadpooldata\1.csv" -s, -W
...
findstr /v /c:"Changed database context to 'ToniqDatabase'." "c:\dp\deadpooldata\3.csv" > "c:\dp\deadpooldata\unichem_russell_street.csv" 
