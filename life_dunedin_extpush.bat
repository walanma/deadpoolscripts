sqlcmd -i "c:\dp\deadpoolscripts\life_dunedin.sql" -o "c:\dp\deadpooldata\1.csv" -s, -W
...
findstr /v /c:"Changed database context to 'ToniqDatabase'." "c:\dp\deadpooldata\3.csv" > "c:\dp\deadpooldata\life_dunedin.csv" 
